...
Resp = InputBox("Please enter the amount of time (in seconds) that the player will have to complete the level. It MUST be 3 digits.", "''Time'' Data Entry", 300)
RichTextBox1.SelStart = Image1.UBound * 2 + 2
RichTextBox1.SelLength = 2
RichTextBox1.SelText = "??"
CommonDialog1.ShowSave
RichTextBox1.SaveFile CommonDialog1.FileName
MsgBox "Good! Save complete. Time information: The player has " & Resp & " seconds to complete the level."
End Sub
...
Image2.Picture = Form3.Image1(RichTextBox1.SelText).Picture
End Sub
...
If Resp = 1 Then
RichTextBox1.Text = ""
Resp = InputBox("Please enter the tile art number of the tile that you wish to cover the map. Note: To make the entire screen land, enter 34. To make the entire screen nothing, enter ???????????????????????????????????????.", "Fill-In", 800000000000000#)
...
Next I
End If
RichTextBox1.Text = RichTextBox1.Text & "??3000"
Image2.Picture = Form3.Image1(0).Picture
End If
